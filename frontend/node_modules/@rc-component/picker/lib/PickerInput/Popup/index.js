...
function Popup(props) {
  ...
  var renderNode = /*#__PURE__*/React.createElement("div", {
    ...
    tabIndex: -1,
    className: (0, _clsx.clsx)(containerPrefixCls, // Used for Today Button style, safe to remove if no need
  ...
  if (range) {
    renderNode = /*#__PURE__*/React.createElement("div", {
      onMouseDown: onPanelMouseDown,
      ref: wrapperRef,
      className: (0, _clsx.clsx)("".concat(prefixCls, "-range-wrapper"), "".concat(prefixCls, "-").concat(picker, "-range-wrapper"))
