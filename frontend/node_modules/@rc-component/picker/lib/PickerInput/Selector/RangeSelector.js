...
function RangeSelector(props, ref) {
  ...
  var syncActiveOffset = (0, _util.useEvent)(function () {
  ...
  return /*#__PURE__*/React.createElement(_resizeObserver.default, {
    ...
    className: (0, _clsx2.clsx)(prefixCls, "".concat(prefixCls, "-range"), _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-focused"), focused), "".concat(prefixCls, "-disabled"), disabled.every(function (i) {
      return i;
