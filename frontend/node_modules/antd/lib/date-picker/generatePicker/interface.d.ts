...
import type { PanelSemanticName as PopupSemantic, Locale as RcPickerLocale, SemanticName } from '@rc-component/picker/interface';
...
export type DatePickerClassNamesType<P> = SemanticClassNamesType<InjectDefaultProps<P>, SemanticName, {
    popup?: string | SemanticClassNames<PopupSemantic>;
}>;
export type DatePickerStylesType<P> = SemanticStylesType<InjectDefaultProps<P>, SemanticName, {
